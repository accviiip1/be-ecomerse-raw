  ...
  return (
    <>
      <CCard className="mb-4">
        <CCardHeader>
          <CRow className="align-items-center">
            <CCol><strong>Discount Campaigns</strong></CCol>
            <CCol className="text-end">
              <CButton color="primary" onClick={openCreate}>New Campaign</CButton>
            </CCol>
          </CRow>
          <CRow className="mt-3">
            <CCol md={4}>
      ...
      <CModal visible={modalOpen} onClose={() => setModalOpen(false)} size="lg" backdrop="static">
        <CModalHeader>
          <CModalTitle>{editing ? 'Edit' : 'Create'} Campaign</CModalTitle>
        </CModalHeader>
