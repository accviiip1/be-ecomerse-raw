    ...
    <CCard className="mb-4">
      <CCardHeader>
        <CRow className="align-items-center">
          <CCol><strong>Products</strong></CCol>
          <CCol className="text-end">
            <CButton color="primary" onClick={openCreate}>Add Product</CButton>
          </CCol>
        </CRow>
        <CRow className="mt-3">
          <CCol md={6}>
      ...
      <CModal visible={modalOpen} onClose={() => setModalOpen(false)} backdrop="static">
        <CModalHeader>
          <CModalTitle>{editing ? 'Edit Product' : 'Add Product'}</CModalTitle>
        </CModalHeader>
        <CForm onSubmit={handleSave}>
          <CModalBody>
            <CRow className="g-3">
              ...
              <CCol md={6}>
                <CFormInput type="number" step="0.01" label="Price" value={form.price} onChange={onChange('price')} />
              </CCol>
              <CCol md={12}>
              ...
              <CCol md={6}>
                <CFormSelect label="Category" value={categoryId} onChange={(e)=>setCategoryId(e.target.value)}>
              ...
              <CCol md={6}>
                <CFormSelect label="Brand" value={brandId} onChange={(e)=>setBrandId(e.target.value)}>
