      ...
      <CCard className="mb-4">
        <CCardHeader>
          <CRow className="align-items-center">
            <CCol><strong>Customer Management</strong></CCol>
          </CRow>
          <CRow className="mt-3">
            <CCol md={3}>
              <CFormInput 
                ...
                {filteredItems.map((u, idx) => {
                  ...
                  return (
                    <CTableRow key={u._id}>
                      ...
                      <CTableDataCell>
                        {u.isActive === false ? <CBadge color="danger">Banned</CBadge> : <CBadge color="success">Active</CBadge>}
                      </CTableDataCell>
                      <CTableDataCell>
                        <div>
                          <div>{u.totalOrders || 0} orders</div>
                          <small className="text-muted">${u.totalSpent || 0} spent</small>
                        </div>
                      </CTableDataCell>
                ...
                <CCard>
                  ...
                  <CCardBody>
                    <CListGroup flush>
                      ...
                      <CListGroupItem>
                        <strong>Average Order Value:</strong> ${selectedUser.totalOrders ? (selectedUser.totalSpent / selectedUser.totalOrders).toFixed(2) : 0}
                      </CListGroupItem>
                      <CListGroupItem>
